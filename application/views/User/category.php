				...
				<div class="sidebar-categories">
					...
					?>
						<li class="main-nav-list">
							<a href="<?= site_url('User/Category/getProdukByCategori/').$q->id_kategori_brg ?>" aria-expanded="false" aria-controls="fruitsVegetable" class=" <?= ($this->uri->segment(4) == $q->id_kategori_brg)? "text-warning" : "" ?>">
								<span class="lnr lnr-arrow-right"></span><?= $q->kategori_brg ?>
