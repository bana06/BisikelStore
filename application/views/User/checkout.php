                ...
                <div>
                    ...
                    <div class="row m-4">
                        ...
                        <div class="col-md-9 mb-2">
                            <label for="" class="h4 float-right">Rp2000000,00</label>
                        </div>
                    </div>
                    <div class="row m-4">
                        <div class="col-md-3 text-center">
                    ...
                    <div class="row m-4">
                        ...
                        <div class="col-md-9 mb-2 mt-3">
                            <label for="" class="h4 float-right text-warning">Rp2000000,00</label>
                        </div>
                    </div>
                    <hr>
                    <button class="btn primary-btn float-right">Bayar dengan Transfer</button>
                </div>
            </div>
        </div>
    </div>
